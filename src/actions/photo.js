 ...
 */
export const getPhotos = (url: string): Action => ({
 ...
 */
export const likePhoto = (id: string): Action => ({
 ...
 * @param {string} id photo id
 */
export const unLikePhoto = (id: string): Action => ({
 ...
 */
export const searchInPhotos = (url: string): Action => ({
 ...
 */
export const getPhoto = (id: string): Action => ({
  type: 'photo/GE_PHOTO',
  id,
});
