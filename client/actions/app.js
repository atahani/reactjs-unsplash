 ...
 */
export const setLastPathName = (pathName: string): Action => ({
 ...
 * @param {bool} status
 */
export const jobStatus = (status: boolean = false): Action => ({
  type: 'app/CH_JOB_ST',
  status,
});
...
export const setSearchValues = (
  ...
  title: string = '',
  value: string = ''
): Action => ({ type: 'app/SE_SEARCH_VALUES', query, title, value });
