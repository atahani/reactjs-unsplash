 ...
 */
export const getAccessToken = (code: string): Action => ({
 ...
 */
export const setAccessToken = (payload: AuthorizeToken): Action => ({
 ...
 */
export const setProfile = (payload: UserProfile): Action => ({
