...
import _CollectionSView from '../CollectionSView';
...
const mapStateToProps = state => {
  ...
  return {idFromUrl: photoId, photo, userCollections: state.items.user_collections, userCollectionsLink: `${API_ROOT}/users/${state.user.user_profile.username}/collections`, showCreateNewCollection};
};
