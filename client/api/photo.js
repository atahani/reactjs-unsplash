 ...
 */
export const likePhoto = (id: string): RESTAPIResponse =>
  postReq(`${API_ROOT}/photos/${id}/like`);

/**
 * unlike photo
 * @param {string} id photo id
 */
export const unLikePhoto = (id: string): RESTAPIResponse =>
  deleteReq(`${API_ROOT}/photos/${id}/like`);

/**
 * get photo by id
 * @param {string} id photo it
 */
export const getPhoto = (id: string): RESTAPIResponse =>
  getReq(`${API_ROOT}/photos/${id}`);
